...
function beforeLoginMainGnb(){
	...
	+		'<a id="kal-logo" href="javascript:void(0)"><span class="main-logo-firstspell">J</span>Lab<span class="main-logo-subtitle">Laboratory System</span></a>'
	+	'</div>'
	+	'<div class="kal-main-right-menu">'
	+		'<button class="kal-main-right-menu-reservation-btn">회사정보</button>'
	+		'<button class="kal-main-right-menu-skypass-btn">사업내용</button>'
	+		'<button class="kal-main-right-menu-service-btn">공지사항'
	...
	+			'</div>'
	+		'</button>'
	+		'<button class="kal-main-right-menu-promotion-btn">찾아오시는길</button>'
	+	'</div>'
	+'</div>';
}
...
function mainFooter(){
	...
	+					'<h2>회사 소개</h2>'
	+					'<ul>'
	+						'<li class="kal-footer-left-content-menu-4-li1"><a href="#">제이랩에 대하여</a></li>'
...
function subGnbAfterLogin(){
	...
	+		'<a class="kal-after-login-sub-right-menu-myregist" href="javascript:void(0)">&nbsp공지 사항 &nbsp&nbsp</a>'
...
function login(){
	...
	+		'<a class="kal-gg-mainlogo" href="javascript:void(0)"><span class="login-first-spell">J</span><span class="login-text">Lab</span><span class="logo-subtext">Laboratory System</span></a>'
	+	'</div>'
	...
	+				'<a href="javascript:void(0)">아이디 찾기</a><span> | </span><a href="javascript:void(0)">비밀번호 찾기</a><span> | </span><a class="kal-gg-registbtn" href="javascript:void(0)">회원가입</a>'
	+			'</div>'
	+		'</div>'
...
function regist(){
	...
	+	'<a class="kal-regist-main-logo" href="javascript:void(0)"><span class="regist-first-spell">J</span><span class="regist-text">Lab</span><span class="regist-subtext">Laboratory System</span></a>'
	+	'<div class="kal-jh-regist-sub-wrapper1">'
	+		'<h1>회원가입</h1>'
	+		'<span class="kal-jh-regist-headerText">제이랩 회원가입에 오신걸 환영합니다.</span>'
